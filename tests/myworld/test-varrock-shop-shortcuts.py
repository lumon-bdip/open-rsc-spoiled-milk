...
def main() -> None:
    ...
    require(client_npcs, 'new NPCDef("Apothecary", "I wonder if he has any good potions", shopOption, 10, 5, 7, 5', "client Apothecary has one trade shortcut command")
    reject(client_npcs, 'new NPCDef("Apothecary", "I wonder if he has any good potions", shopOption, shopOption', "client Apothecary duplicate trade shortcut commands")
    ...
    reject(server_entity_handler, 'npcs.get(NpcId.APOTHECARY.id()).setCommand2("Trade");', "runtime Apothecary duplicate Trade command")
