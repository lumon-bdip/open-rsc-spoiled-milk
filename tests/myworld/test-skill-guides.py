...
def main() -> None:
    ...
    require(client, 'skillGuideChosenTabs.add("Scythes");', "melee scythes tab")
    require(client, 'skillGuideChosenTabs.add("Info");', "melee info tab")
    ...
    require(guide, 'addMeleeTierGuide("Tin scythe", 1, 3181);', "tin scythe melee guide")
    require(guide, 'addMeleeTierGuide("Rune scythe", 70, 3190);', "rune scythe melee guide")
    require(guide, 'Scythes cannot be used with a shield', "scythe shield melee guide info")
    require(guide, '2-handers cannot be equipped with a shield', "2-hander shield melee guide info")
    require(guide, 'Scythes hit an area around the player', "scythe aoe melee guide info")
    require(guide, 'Maces give prayer point bonuses', "mace prayer melee guide info")
    ...
    require(guide, 'addAmmoMouldGuide("Tin", 1, 190, 2004, 2039, 2043, 1996, 3208);', "tin ammo crafting guide")
    require(guide, 'addAmmoMouldGuide("Rune", 70, 2194, 674, 646, 1070, 1080, 3217);', "rune ammo crafting guide")
    require(guide, 'name + " bolts - 1 bar makes 5"', "bolt crafting guide line")
    require(guide, 'name + " shuriken - 1 bar makes 9"', "shuriken crafting guide line")
    require(guide, 'new SkillMenuItem(3208, "", "Shuriken use Crafting and molds")', "shuriken crafting info wording")
    ...
    require(guide, 'addSmithingTier("Exalted Rune", 90, 3262, 3263, 3264, 3265, 3266, 3267, 3268, 3269, 3271, 3270, 3273, -1, 3274, 3275, 3276, 3277, 3278, 3279, 3280);', "exalted rune smithing guide")
    ...
    require(guide, 'new SkillMenuItem(3261, "90", "Purified Rune Bar - 1 rune bar and 14 dragon sulfur at the repaired lava forge")', "purified rune bar smelting guide")
    require(guide, 'addSmithingTier("Dragon", 80, 1447, -1, 593, -1, 1346, 594, -1, 2752, -1, -1, -1, -1, 1425, -1, -1, 1278, 1426, 1429, 1427);', "dragon smithing tier guide")
    ...
    require(guide, 'addWoodcraftGuide("Basic", 10, 1, 277, 5, 276, 8, 60, 9, 100, 1, 377, 1);', "basic woodcraft recipe guide")
    require(guide, 'addWoodcraftGuide("Pine", 15, 8, 2116, 12, 2115, 15, 59, 16, 2131, 8, 2682, 8);', "pine woodcraft recipe guide")
    require(guide, 'addWoodcraftGuide("Willow", 25, 22, 661, 26, 660, 29, 2170, 30, 1769, 22, 2684, 22);', "willow base staff woodcraft guide")
    require(guide, 'addWoodcraftGuide("Maple", 35, 38, 663, 40, 662, 43, 2172, 44, 1774, 38, 2686, 38);', "maple base staff woodcraft guide")
    require(guide, 'addWoodcraftGuide("Yew", 40, 46, 665, 47, 664, 50, 2173, 51, 1779, 46, 2687, 46);', "yew base staff woodcraft guide")
    require(guide, 'addWoodcraftGuide("Magic", 50, 62, 667, 61, 666, 64, 2175, 65, 1784, 62, 2689, 62);', "magic base staff woodcraft guide")
    require(guide, 'addWoodcraftGuide("Blood", 55, 70, 2128, 67, 2127, 70, 2176, 72, 2146, 70, 2690, 70);', "blood woodcraft recipe guide")
    require(guide, 'int staffId, int staffLevel, int fishingRodId, int fishingRodLevel', "woodcraft guide fishing rod helper parameters")
    require(guide, 'EntityHandler.getItemDef(fishingRodId).name', "woodcraft guide fishing rod item names")
    ...
    require(guide, '"fern leaf", "mushroom", "fungus", "limpwurt root", "red flower", "blue flower"', "brawn potion family guide")
