...
def main() -> None:
    with tempfile.TemporaryDirectory(prefix="renderer-session-analyzer-") as tmp_name:
        ...
        for snippet in (
            ...
            "Native buffer pool `direct` first/last/max: 4000000 / 5000000 / 5000000 bytes.",
            "Login epoch 1: 5.0s, 2 telemetry records, 1 GC collections, 1 section loads; old-gen post-GC 80000000->92000000 bytes; direct 4000000->5000000 bytes.",
