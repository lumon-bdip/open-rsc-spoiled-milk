...
def main() -> None:
    ...
    require(client_config, "CLIENT_VERSION = 10042;", "Client protocol version")
    require(myworld_conf, "client_version: 10042", "MyWorld server protocol version")
    require(myworld_host_conf, "client_version: 10042", "Hosted MyWorld server protocol version")
