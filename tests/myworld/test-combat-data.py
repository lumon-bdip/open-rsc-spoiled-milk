...
def main() -> None:
    ...
    require_exact(items_by_id, 3235, "meleeOffense", items_by_id[75]["meleeOffense"], "Fire sword long sword profile")
    require_exact(items_by_id, 3235, "weaponSpeed", 4, "Fire sword one-tick-faster long sword profile")
    require_exact(effective_items_by_id, 3235, "appearanceID", 1035, "Fire sword custom equipped visual")
    require_exact(items_by_id, 3236, "meleeOffense", items_by_id[75]["meleeOffense"], "Ice sword long sword profile")
    require_exact(items_by_id, 3236, "weaponSpeed", 4, "Ice sword one-tick-faster long sword profile")
    require_exact(effective_items_by_id, 3236, "appearanceID", 1036, "Ice sword custom equipped visual")
    require_exact(items_by_id, 3237, "meleeOffense", items_by_id[75]["meleeOffense"], "Earth sword long sword profile")
    require_exact(items_by_id, 3237, "weaponSpeed", 4, "Earth sword one-tick-faster long sword profile")
