...
def main() -> None:
    ...
    for snippet in (
        ...
        '"Utility uses are spent only on successful tasks"',
        '"Pack Rat has 4 uses; Delivery Camel has 2"',
    ...
    for snippet in (
        ...
        '"Geode focus: Just the ore, A few, Plenty, Lots"',
        '"Higher geode focus increases rare geode rolls"',
