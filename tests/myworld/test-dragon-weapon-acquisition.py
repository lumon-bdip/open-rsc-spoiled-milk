...
RANGERS_GUILD_POINTS_VENDOR_PATH = ROOT / "server/plugins/com/openrsc/server/plugins/custom/npcs/RangersGuildPointsVendor.java"
...
def main() -> None:
    ...
    rangers_guild_points_vendor = RANGERS_GUILD_POINTS_VENDOR_PATH.read_text(encoding="utf-8")
    ...
    forbid(rangers_guild_dragon_shop, "ItemId.DRAGON_ARROWS", "Dragon arrows should be points-only")
    forbid(rangers_guild_dragon_shop, "ItemId.POISON_DRAGON_ARROWS", "Poison dragon arrows should be points-only")
    forbid(rangers_guild_dragon_shop, "ItemId.DRAGON_BOLTS", "Dragon bolts should be points-only")
    forbid(rangers_guild_dragon_shop, "ItemId.POISON_DRAGON_BOLTS", "Poison dragon bolts should be points-only")
    require(rangers_guild_points_vendor, "new Reward(ItemId.DRAGON_ARROWS, 30)", "Talia should redeem dragon arrows for points")
    require(rangers_guild_points_vendor, "new Reward(ItemId.POISON_DRAGON_ARROWS, 30)", "Talia should redeem poison dragon arrows for points")
    require(rangers_guild_points_vendor, "new Reward(ItemId.DRAGON_BOLTS, 30)", "Talia should redeem dragon bolts for points")
    require(rangers_guild_points_vendor, "new Reward(ItemId.POISON_DRAGON_BOLTS, 30)", "Talia should redeem poison dragon bolts for points")
