...
def main() -> None:
    require_snippets(
        MINING_PLUGIN,
        (
            "MINING_FOCUS_SOME_GEODES",
            "MINING_FOCUS_MORE_GEODES",
            "MINING_FOCUS_NO_GEODES",
            "MINING_FOCUS_MOST_GEODES",
            'return "Just the ore";',
            'return "Plenty of geodes";',
            'return "Lots of geodes";',
            'return "A few geodes";',
            "MYWORLD_GEODE_REWARD_BASE_CHANCE = 1.0D / 50.0D",
            "private static double getRandomGeodeChance(Player player)",
            "return baseChance * 1.5D;",
            "return baseChance * 2.0D;",
            "return 0.0D;",
            "You find a geode, but have no room to keep it",
