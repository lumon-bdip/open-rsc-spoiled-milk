...
def main() -> None:
    ...
    require(tags, 'equalsAny(name, "gold ore", "gold bar", "silver ore", "silver bar", "wool", "ball of wool")', "crafting jewelry metal and wool materials")
    ...
    forbid(tags, 'containsAny(name, "gold ore", "gold bar", "silver ore", "silver bar", "mould")', "generic mould crafting jewelry classification")
