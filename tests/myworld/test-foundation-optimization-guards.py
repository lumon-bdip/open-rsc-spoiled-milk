...
def main() -> None:
    ...
    require_snippet(GAME_STATE_UPDATER, "recordUpdateGameObjects(() -> sceneryChanged[0] = updateGameObjects(player, visibleSceneryObjects));", "scenery object update view reuse")
    require_snippet(GAME_STATE_UPDATER, "recordUpdateWallObjects(() -> wallsChanged[0] = updateWallObjects(player, visibleWallObjects));", "wall object update view reuse")
