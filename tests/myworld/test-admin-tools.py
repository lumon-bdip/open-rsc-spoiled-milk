...
def main() -> None:
	...
	require(player_login, '"devduck".equalsIgnoreCase(player.getUsername())', "devduck staff group guard")
	require(player_login, "player.setGroupID(Group.DEV)", "devduck developer group assignment")
	require(player_login, '"anactualduck".equalsIgnoreCase(player.getUsername())', "anactualduck staff group guard")
