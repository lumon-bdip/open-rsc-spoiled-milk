...
public class Config {
	...
	static String WINDOW_TITLE = "Spoiled Milk"; // Only set here due to config not set by server fast enough at load time
	...
	public static final int CLIENT_VERSION = 10032;
	...
	public static int C_NPC_MOVE_PER_FRAME = 4;
	...
	public static boolean S_WANT_CUSTOM_SPRITES = true;
