	...
	public void thormacDialogue(Player player, Npc n, int choice) {
			...
			switch (player.getQuestStage(this)) {
				...
				case -1:
					...
					int four = multi(player, n, "That's ok",
						"Can you still enchant staffs for me?");
					if (four == 1) {
						npcsay(player, n,
							"I used to, but Enchanting has replaced my old battlestaff work",
							"If you want an elemental staff now, take a proper staff to the matching altar",
							"The altar attunes it directly without all that orb business");
					}
					break;
			}
		}
		...
		// What's in it for me?
			...
			npcsay(player, n,
				...
				"These days that means pointing you toward Enchanting altars",
				"They do a far cleaner job of attuning staffs than my old battlestaff work");
