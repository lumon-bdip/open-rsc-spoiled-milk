...
public class CombinePotions implements UseInvTrigger {
	...
	int[][] combinePotions = {
		...
		{ItemId.ONE_RUNECRAFT_POTION.id(), ItemId.TWO_RUNECRAFT_POTION.id(), ItemId.FULL_RUNECRAFT_POTION.id()},
		{ItemId.ONE_SUPER_RUNECRAFT_POTION.id(), ItemId.TWO_SUPER_RUNECRAFT_POTION.id(), ItemId.FULL_SUPER_RUNECRAFT_POTION.id()},
		{ItemId.ONE_SUPER_RANGING_POTION.id(), ItemId.TWO_SUPER_RANGING_POTION.id(), ItemId.FULL_SUPER_RANGING_POTION.id()},
		{ItemId.ONE_SUPER_MAGIC_POTION.id(), ItemId.TWO_SUPER_MAGIC_POTION.id(), ItemId.FULL_SUPER_MAGIC_POTION.id()},
		{ItemId.ONE_WARRIORS_BREW.id(), ItemId.TWO_WARRIORS_BREW.id(), ItemId.FULL_WARRIORS_BREW.id()},
		{ItemId.ONE_STRONG_WARRIORS_BREW.id(), ItemId.TWO_STRONG_WARRIORS_BREW.id(), ItemId.FULL_STRONG_WARRIORS_BREW.id()},
		{ItemId.ONE_POTION_OF_BRAWN_V6.id(), ItemId.TWO_POTION_OF_BRAWN_V6.id(), ItemId.FULL_POTION_OF_BRAWN_V6.id()},
		{ItemId.ONE_POTION_OF_DEFTNESS_V6.id(), ItemId.TWO_POTION_OF_DEFTNESS_V6.id(), ItemId.FULL_POTION_OF_DEFTNESS_V6.id()},
		{ItemId.ONE_POTION_OF_INSIGHT_V6.id(), ItemId.TWO_POTION_OF_INSIGHT_V6.id(), ItemId.FULL_POTION_OF_INSIGHT_V6.id()},
	};
