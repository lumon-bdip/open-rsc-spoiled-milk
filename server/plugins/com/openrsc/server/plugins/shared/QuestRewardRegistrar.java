...
public final class QuestRewardRegistrar extends AbstractRegistrar {
	...
	public void init(Server server) {
		...
		// 14 - VAMPIRE_SLAYER
		rewardsList = new ArrayList<>();
		rewardsList.add(new XPReward(Skill.MELEE, 1300, 600));
		if (awardInfluence)
			rewardsList.add(new XPReward(Skill.INFLUENCE, 400, 300));
		skillRewardsAdd = new XPReward[rewardsList.size()];
		...
		Collections.addAll(rewardsList,
			new XPReward(Skill.MELEE, 2600, 1200),
			new XPReward(Skill.MELEE, 2600, 1200));
		skillRewardsAdd = new XPReward[rewardsList.size()];
		...
		rewardsList = new ArrayList<>();
		Collections.addAll(rewardsList,
			new XPReward(Skill.MELEE, 300, 200),
			new XPReward(Skill.MELEE, 300, 200),
		...
		// 22 - SCORPION_CATCHER
		rewardsList = new ArrayList<>();
		rewardsList.add(new XPReward(Skill.MELEE, 1500, 500));
		skillRewardsAdd = new XPReward[rewardsList.size()];
		...
		Collections.addAll(rewardsList,
			...
			new XPReward(Skill.CRAFTING, 2000, 1000));
		skillRewardsAdd = new XPReward[rewardsList.size()];
		...
		Collections.addAll(rewardsList,
			...
			new XPReward(Skill.MELEE, 1200, 1200));
		skillRewardsAdd = new XPReward[rewardsList.size()];
		...
		rewardsList = new ArrayList<>();
		Collections.addAll(rewardsList,
			new XPReward(Skill.MELEE, 700, 800),
		...
		rewardsList = new ArrayList<>();
		rewardsList.add(new XPReward(Skill.MELEE, 800, 900));
		skillRewardsAdd = new XPReward[rewardsList.size()];
		...
		rewardsList = new ArrayList<>();
		Collections.addAll(rewardsList,
			new XPReward(Skill.MELEE, 1000, 900),
			new XPReward(Skill.MELEE, 1000, 900));
		skillRewardsAdd = new XPReward[rewardsList.size()];
		...
		Collections.addAll(rewardsList,
			...
			new XPReward(Skill.MELEE, 1600, 1200),
		...
		Collections.addAll(rewardsList,
			...
			new XPReward(Skill.MELEE, 2000, 200));
		skillRewardsAdd = new XPReward[rewardsList.size()];
