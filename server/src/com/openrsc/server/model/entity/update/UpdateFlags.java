...
public class UpdateFlags {
	...
	public void setCombatEffect(CombatEffect combatEffect) {
		this.combatEffect.set(combatEffect);
		if (combatEffect != null) {
			this.combatEffects.add(combatEffect);
		}
	}
	...
	public List<HitSplat> getHitSplats() {
		return new ArrayList<HitSplat>(hitSplats);
	}
	...
	public boolean hasCombatEffect() {
		return !combatEffects.isEmpty() || getCombatEffect().get() != null;
	}

	public boolean hasHitSplats() {
