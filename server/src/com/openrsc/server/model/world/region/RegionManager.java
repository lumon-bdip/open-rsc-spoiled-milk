...
public class RegionManager {
	...
	public Collection<GameObject> getLocalObjects(final Mob entity) {
		...
		for (final Iterator<Region> region = getVisibleRegions(entity.getLocation(), getWorld().getServer().getConfig().OBJECT_VIEW_DISTANCE).iterator(); region.hasNext(); ) {
	...
	public Collection<GroundItem> getLocalGroundItems(final Mob entity) {
		...
		for (final Region region : getVisibleRegions(entity.getLocation(), getWorld().getServer().getConfig().OBJECT_VIEW_DISTANCE)) {
	...
	public LinkedHashSet<Region> getVisibleRegions(final Point location) {
		return getVisibleRegions(location, getWorld().getServer().getConfig().VIEW_DISTANCE);
	}

	private LinkedHashSet<Region> getVisibleRegions(final Point location, final int gridDistance) {
