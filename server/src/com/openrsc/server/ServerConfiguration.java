...
public class ServerConfiguration {
	...
	public int OBJECT_VIEW_DISTANCE;
	...
	void initConfig(String defaultFile) throws IOException {
		...
		OBJECT_VIEW_DISTANCE = tryReadInt("object_view_distance").orElse(VIEW_DISTANCE);
		...
		WANT_PVP = tryReadBool("want_pvp").orElse(true);
