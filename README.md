...
| Summoning | Magic enemies |
| --- | --- |
| <img src="docs/myworld/screenshots/readme/summoning-tab-ironhide-bear.png" alt="Summoning tab with an Ironhide Bear beside the player" width="420"> | <img src="docs/myworld/screenshots/readme/dark-wizard-fireball.png" alt="A dark wizard casting a fireball" width="420"> |
| The new Summoning tab also shows the skill-icon interface. The Ironhide Bear summon is standing beside the player. | Enemies can attack with Magic. Magic power and Magic defense are both in the game and matter. |

| Ranged enemies | Multi-melee and AoE |
| --- | --- |
| <img src="docs/myworld/screenshots/readme/thief-throwing-dagger.png" alt="A thief throwing a dagger at the player" width="420"> | <img src="docs/myworld/screenshots/readme/multi-melee-aoe-weapon.png" alt="Multiple thugs attacking while the player fights back with an AoE melee weapon" width="420"> |
| Thieves and other enemies can use ranged attacks. Ranged power and Ranged defense exist too. | Multiple enemies can attack in melee at once, and AoE melee weapons can answer back. |

| AoE spells | AoE ranged |
| --- | --- |
| <img src="docs/myworld/screenshots/readme/aoe-spell-animation.png" alt="An AoE spell animation in combat" width="420"> | <img src="docs/myworld/screenshots/readme/shuriken-aoe-ranged.png" alt="Shurikens used as an AoE ranged attack" width="420"> |
| Spells have new animations, including AoE magic effects. | Ranged users have AoE options too, including shurikens. |

### Gear And Areas

| Defensive armor identities | Crafting Guild expansion |
| --- | --- |
| <img src="docs/myworld/screenshots/readme/leather-armor-sets.png" alt="Different leather armor sets in the equipment interface" width="420"> | <img src="docs/myworld/screenshots/readme/crafting-guild-expansion.png" alt="Expanded Crafting Guild with new ores" width="420"> |
| Armor is now purely defensive instead of being tied to combat styles. Leather armor inherits defenses from the monster it is made from and has unique set bonuses. | Guilds are being expanded with more resources and more reasons to visit them. |

| Karamja Volcano expansion | Heroes' Guild expansion |
| --- | --- |
| <img src="docs/myworld/screenshots/readme/karamja-volcano-rune-altar.png" alt="Karamja Volcano expansion with an overworld rune altar" width="420"> | <img src="docs/myworld/screenshots/readme/heroes-guild-expansion.png" alt="Expanded Heroes' Guild area" width="420"> |
| This Karamja Volcano expansion shows an overworld rune altar. Rune altars are not just for crafting runes anymore; they are part of the larger Enchanting system. | The goal is for every guild to feel bigger and better than it did before. |

### Handy UI Stuff

| Bank filters | Crafting interfaces |
| --- | --- |
| <img src="docs/myworld/screenshots/readme/bank-filters.png" alt="Bank interface with new item filters" width="420"> | <img src="docs/myworld/screenshots/readme/crafting-interface.png" alt="Crafting production interface" width="420"> |
| The bank has new filters, and the old binary item limit is gone. No more strange bank wraparound bug. | Crafting interfaces replace the old dialogue-menu crafting flow. |

| Quest shortcuts |
| --- |
| <img src="docs/myworld/screenshots/readme/quest-shortcut.png" alt="Quest shortcut option in dialogue" width="860"> |
| Already done the quests? Done them a lot? Do not want to do them again? Skip them. Take the rewards, or do not. Your call. |
