...
final class RendererRuntimeDefaults {
	...
	static void apply() {
		...
		setDefault("spoiledmilk.openglVsync", "SPOILED_MILK_OPENGL_VSYNC", "false");
		...
		setDefault("spoiledmilk.openglWorldChunksSpatialCull", "SPOILED_MILK_OPENGL_WORLD_CHUNKS_SPATIAL_CULL", "true");
		setDefault("spoiledmilk.openglWorldChunkUploadBudgetMs", "SPOILED_MILK_OPENGL_WORLD_CHUNK_UPLOAD_BUDGET_MS", "3.0");
